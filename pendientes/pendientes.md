...
Última revisión: 14 de septiembre de 2026 (noche). Solo quedan asuntos abiertos; lo resuelto se retiró de esta lista y vive en `CLAUDE.md` y en `claude/auditoria-*.md`. **Producción (Cloudflare): v75 (`sia-v35-2026-09-14e`), publicada el 14-sep y verificada en GitHub `main`.** Repositorio local: v78 (`sia-v35-2026-09-14h`: hoja de ficha a pantalla completa al cambiar el alto del navegador, PGOEDF por encima de la zonificación del PM con nota de cobertura, filete en el buscador; pendiente de publicar). v76 (`14f`) publicada el 14-sep; v77 (`14g`) entregada.
