...
Última revisión: 14 de septiembre de 2026 (noche). Solo quedan asuntos abiertos; lo resuelto se retiró de esta lista y vive en `CLAUDE.md` y en `claude/auditoria-*.md`. **Producción (Cloudflare): v75 (`sia-v35-2026-09-14e`), publicada el 14-sep y verificada en GitHub `main`.** Repositorio local: v79 (`sia-v35-2026-09-14i`: capas del mini-mapa dinámicas por cobertura real, hoja de ficha a pantalla completa al cambiar el alto del navegador, filete en el buscador; pendiente de publicar). v76 (`14f`) publicada el 14-sep; v77 (`14g`) y v78 (`14h`) entregadas.
