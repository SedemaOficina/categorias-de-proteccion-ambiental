...
Última revisión: 14 de septiembre de 2026 (noche). Solo quedan asuntos abiertos; lo resuelto se retiró de esta lista y vive en `CLAUDE.md` y en `claude/auditoria-*.md`. **Producción (Cloudflare): v75 (`sia-v35-2026-09-14e`), publicada el 14-sep y verificada en GitHub `main`.** Repositorio local: v76 (`sia-v35-2026-09-14f`, menú de capas rediseñado; pendiente de publicar).
